angular.module('TaskMDL').controller('addDocCController', ['$scope', '$rootScope', '$mdDialog', 'clientesServices', 'mdlClienteDoc',
    function ($scope, $rootScope, $mdDialog, clientesServices, mdlClienteDoc) {
        $scope.loading = false;
        ...
        $scope.CargarDocA = function (doc, ev) {
            $scope.loading = true;
            try {
                //if ($scope.FileUID) {
                ...
                clientesServices.CargarDocA(data, function (response) {
                    $scope.loading = false;
                    if (doc.intDocClienteID == 9 || doc.intDocClienteID == 10) {
                        if (response.client != null) {
                            $mdDialog.show({
                                controller: 'validacionClienteController',
                                templateUrl: 'app/modules/home/admin/clientes/validacionDatosCliente/validacionClienteView.html',
